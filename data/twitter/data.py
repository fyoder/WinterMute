...
def Test_Numpy_Merge():
    comb_a = np.concatenate(('idx_a.npy', '../cornell_corpus/idx_a.npy'), axis=1)
    comb_q = np.concatenate(('idx_q.npy', '../cornell_corpus/idx_q.npy'), axis=1)
    np.save('comb_a.npy', comb_a)
    np.save('comb_q.npy', comb_q)
